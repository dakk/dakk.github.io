var store = [{
        ...
        "title": "Free Maps on Garmin eTrex 10 (and all Garmin GPSs)",
        "excerpt":"Despite it is sold as a non-cartographic handled GPS device, with limited storage capacity of 10 MB and the inability to expand it, the eTrex 10 GPS, like almost all Garmin devices, is capable of reading Garmin maps in IMG format. However, the storage limitation prevents to use standard Garmin...","categories": ["gis"],
        "tags": [],
